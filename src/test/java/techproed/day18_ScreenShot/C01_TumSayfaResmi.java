...
public class C01_TumSayfaResmi extends TestBase {
   ...
   oranın yolunu belirtiriz.
    ...
    public void test01() throws IOException {
        ...
        //1-İlk olarak SS aldığımızda nereye kaydetmek istiyorsak oranın yolunu belirtelim
        String dosyaYolu = "src/test/java/techproed/TumSayfaResmi/screenShot.png";

        //2-İkinci olarak TakesScreenShot arayüzünden obje oluştururuz
        TakesScreenshot ts = (TakesScreenshot) driver;

        //3-Üçüncü olarak FileUtils class'ından copyFile() methodu ile ts objemizi kullanarak getScreenShotAs methodu ile
