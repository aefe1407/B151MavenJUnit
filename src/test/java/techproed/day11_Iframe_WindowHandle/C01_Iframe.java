...
public class C01_Iframe extends TestBase {
    ...
    geçiş yapmamız gerekir. Eğer geçiş yapmazsak nosuchelementexception alırız.
         ...
         Alert'ten farkı alert çıktığında hiçbir webelementi locate edemeyiz. Iframe da locate ederiz fakat
    handle edemeyiz.
    ...
    public void iframe() {
        ...
        //driver.get(driver.getCurrentUrl()); -->Sayfayı yeniler. bu şekilde sayfayı yenilesek de iframeden çıkar.
        //driver.navigate().refresh(); -->Sayfayı yeniler. bu şekilde sayfayı yenilesek de iframeden çıkar.
