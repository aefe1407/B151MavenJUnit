...
public class C02_Alerts extends TestBase {
        ...
        /*
        Eğer bir sayfadaki bir butona tıkladığımızda bir uyarı pencersi çıkıyorsa ve bu çıkan pencereye sağ klik
        yapıp locate alamıyorsak, bu bir js Alert'tür.
        js Alert'ü handle edebilmek için drivermızı o pencere geçirmemiz gerekir. Bunun için;
    ...
    public void dissmissAlert() {
        ...
        WebElement resultMessage = driver.findElement(By.xpath("(//p)[2]"));
        String istenenMetin = "succesfully";
    ...
    public void sendKeysAlert() {
        ...
        bekle(3);
        WebElement resultMessage = driver.findElement(By.xpath("(//p)[2]"));//You entered: Ahmet
        String girilenMetin = "Ahmet";
